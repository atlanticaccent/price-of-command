...
sealed class PersonalityChangeScar(
    ...
    companion object {
        val personalities: Map<Class<out PersonalityChangeScar>, PersonalityAPI> by lazy {
            mapOf(
    ...
    override fun tryResolve() {
        target.stats.setSkillLevel("pc_scar_${personalityId.lowercase()}", 0f)
    }
