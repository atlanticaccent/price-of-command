...
class pc_EvilOptionDelegate(private val dialog: InteractionDialogAPI, private val optionId: OptionId, private val accept: Boolean = false) : BaseStoryPointActionDelegate() {
    companion object {
        const val OPTION_ID = "pc_fleet_interaction_dialog_sp_option_evil"
    }
